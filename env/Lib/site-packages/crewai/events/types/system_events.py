...
class SignalType(IntEnum):
    ...
    SIGHUP = getattr(signal, 'SIGHUP', 1)  # SIGHUP doesn't exist on Windows
    SIGTSTP = getattr(signal, 'SIGTSTP', 20)  # SIGTSTP doesn't exist on Windows
    SIGCONT = getattr(signal, 'SIGCONT', 18)  # SIGCONT doesn't exist on Windows
